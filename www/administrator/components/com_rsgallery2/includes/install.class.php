...
class rsgInstall {
    ...
    */
        ...
        if (!in_array($item,$exceptions))
            ...
            if (is_file($from))
                ...
                if (@copy($from,$to))
                    ...
                    $messages[]=_RSGALLERY_INSTALL_FILE_COPIED_FROM.$from._RSGALLERY_INSTALL_FILE_COPIED_TO.$to;
                    }
                else
                    {
    ...
    global $database;
    $sql = "SELECT COUNT(*) FROM #__components as a WHERE a.option = '$component'";
