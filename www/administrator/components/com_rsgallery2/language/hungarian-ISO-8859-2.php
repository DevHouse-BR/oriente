...
DEFINE("_RSGALLERY_MAKECAT_ALERT_NAME",		"Kérjük, hogy írja be a galéria nevét.");
DEFINE("_RSGALLERY_MAKECAT_ALERT_DESCR",	"Kérjük, hogy készítse el a leírást.");
...
DEFINE("_RSGALLERY_COMMENT_DELETE",			"Biztosan törölni akarja ezt a véleményt?");
...
DEFINE("_RSGALLERY_DELIMAGE_TEXT",			"Biztosan törölni akarja ezt a képet?");
...
DEFINE("_RSGALLERY_NO_USER_GAL",			"Még nem hozott létre saját galériát");
DEFINE("_RSGALLERY_DELCAT_TEXT",			"Biztosan törölni akarja ezt a galériát?\\nHa tárol még képeket ebben a galériában, akkor azok is törlésre kerülnek.");
...
DEFINE("_RSGALLERY_BATCH_METHOD_TIP",		"Válassza ki, hogy egyetlen fájlt, egy ZIP fájlt, vagy egy teljes könyvtárat akar-e feltölteni");
...
DEFINE("_RSGALLERY_REAL_UNINST_DONE",		"Kész.  Távolítson el a fentiek közül mindent, ha hiba lépett föl.  Távolítsa el MÁRIS az RSGallery2 komponenst, vagy továbbra is hibák fognak felmerülni.");
...
DEFINE("_RSGALLERY_BATCH_ERROR_FTP1",		"Nem létezik az Ön által kiválasztott könyvtár.\\n Most vissza fog jutni a feltöltési oldalra.");
//function showUpload
...
DEFINE("_RSGALLERY_INSTALL_SUCCESS",		"Sikerült!  Most már ezt használja: RSGallery2 ");
...
//galleries.class.php
//function check
/*new*/DEFINE("_RSGALLERY_GAL_EXIST_ERROR",		"Már van ilyen nevû galéria. Kérjük, hogy próbálkozzon újra.");
//galleries.html.php
//function show
...
/*new*/DEFINE("_RSGALLERY_PERMS_NOT_EXIST",				" Nem létezik. Kérjük, hogy FTP-n hozza létre kézzel, és ellenõrizze az engedélyeket");
...
/*new*/DEFINE("_RSGALLERY_PERMS_NOT_SET_TRY_FTP",		".<br />Kérjük, hogy FTP-n keresztül próbálja meg módosítani ezeket az engedélyeket.");
...
/*new*/DEFINE("_RSGALLERY_INSTALL_STATUS_MSGS",			"Ha van valamilyen figyelemre méltó állapotüzenet, akkor kérjük, hogy tekintse meg, mielõtt felkeresi a kezelõpultot.");
//function deleteTable
/*new*/DEFINE("_RSGALLERY_TABLEDEL_OK",					" törlése megtörtént");
/*new*/DEFINE("_RSGALLERY_TABLEDEL_NOTOK",				" nem törölhetõ.<br />Törölje kézzel.");
...
/*new*/DEFINE("_RSGALLERY_MIGRATE_ZOOM_OK",		"a Zoom Gallery áttelepítése befejezõdött. Keresse fel a kezelõpultot.");
...
/*new*/DEFINE("_RSGALLERY_UPGRADE_THUMB_TRANF_ERROR",		"Hibák merültek föl a bélyegképfájlok új szerkezetbe történõ átvitelekor.<br />Kérjük, hogy FTP-n keresztül ellenõrizze.");
/*new*/DEFINE("_RSGALLERY_UPGRADE_DISP_CREATE",		"A megjelenített képek létrehozása sikerült.");
/*new*/DEFINE("_RSGALLERY_UPGRADE_DISP_CREATE_ERROR",		"Nem sikerült létrehozni néhány vagy az összes megjelenített képet.<br />Lépjen kapcsolatba a komponens fejlesztõivel.");
